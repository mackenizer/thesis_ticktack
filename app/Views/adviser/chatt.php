...
<div class="bg-light border-right" id="sidebar-wrapper">
  ...
  <div class="list-group list-group-flush">
    ...
    <a class="nav-link active" href="<?=base_url()?>/chatt" class="list-group-item list-group-item-action bg-light"><i class="far fa-user-md-chat"></i> Chat</a>
...
<div class="wrapper-2 mt-4">
    <section class="users">
      ...
      <header>
        ...
        <div class="content">
         <?php if(!$user == null) :?>
          <img src="<?=base_url()?>/uploads/addPic/<?=session()->get('pic_a')?>" alt="">
          <div class="details">
            
            <span><?= $user['adviser_name']?></span>
            <p><?= $user['status_a']?></p>
          </div>
        </div>
        <?php endif; ?>
      ...
      <div class="users-list">
        <a href="<?=base_url()?>/chatuser/<?= $disp['studentID']?>">
          <div class="content">
