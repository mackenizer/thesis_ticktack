...
<div class="bg-light border-right" id="sidebar-wrapper">
  ...
  <div class="list-group list-group-flush">
    <a class="nav-link" href="<?=base_url()?>/student" class="list-group-item list-group-item-action bg-light"><i class="fas fa-home"></i> Dashboard</a>
    <a href="<?=base_url()?>/moduleteam" class="nav-link" class="list-group-item list-group-item-action bg-light"><i class="fas fa-user-friends"></i> My Team</a>
    <a class="nav-link active" href="<?=base_url()?>/studentchat" class="list-group-item list-group-item-action bg-light"><i class="far fa-user-md-chat"></i> Chat</a>
...
<div class="wrapper mt-4">
    <section class="chat-area">
      ...
      <?php if(!$chat == null) :?>
          ...
          <img class="rounded-circle" src="<?=base_url()?>/uploads/addPic/<?=$chat['pic_a']?>" alt="">
      ...
      <form method="post" action="<?= base_url()?>/chatadviser/<?= $uri->getSegment(2) ?>" class="typing-area" autocomplete="off">
